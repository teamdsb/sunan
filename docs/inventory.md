...
| [docs/requirements/M7-安全管理底座与核心闭环.md](requirements/M7-安全管理底座与核心闭环.md)         | `current-spec`       | `requirements` | 里程碑 7 需求文档：安全管理底座与核心闭环     |
| [docs/requirements/M8-专业安全业务深化与体系完善.md](requirements/M8-专业安全业务深化与体系完善.md) | `current-spec`       | `requirements` | 里程碑 8 需求文档：专业安全业务深化与体系完善 |
...
| 文档                                                                        | 状态            | 负责人     | 标题                                    |
| --------------------------------------------------------------------------- | --------------- | ---------- | --------------------------------------- |
| [docs/plans/M7-M8-upgrade-roadmap.md](plans/M7-M8-upgrade-roadmap.md)       | `current-spec`  | `planning` | M7-M8 升级总路线图：安全管理数字化闭环  |
| [docs/plans/M7-execplans.md](plans/M7-execplans.md)                         | `current-spec`  | `planning` | M7 执行计划：安全管理底座与核心闭环     |
| [docs/plans/M7-wave-backlog.md](plans/M7-wave-backlog.md)                   | `current-spec`  | `planning` | M7 分 Wave 实施清单                     |
| [docs/plans/M8-execplans.md](plans/M8-execplans.md)                         | `current-spec`  | `planning` | M8 执行计划：专业安全业务深化与体系完善 |
...
| 文档                                                                                      | 状态            | 负责人     | 标题                                         |
| ----------------------------------------------------------------------------------------- | --------------- | ---------- | -------------------------------------------- |
| [docs/prompts/README.md](prompts/README.md)                                               | `current-index` | `delivery` | M7/M8 Wave 实施提示词索引                    |
| [docs/prompts/m7/wave-1-spec-baseline.md](prompts/m7/wave-1-spec-baseline.md)             | `operations`    | `delivery` | M7 Wave 1 提示词：文档、架构与规格基线       |
| [docs/prompts/m7/wave-2-permission-workflow.md](prompts/m7/wave-2-permission-workflow.md) | `operations`    | `delivery` | M7 Wave 2 提示词：数据权限与流程状态链       |
| [docs/prompts/m7/wave-3-evidence-export.md](prompts/m7/wave-3-evidence-export.md)         | `operations`    | `delivery` | M7 Wave 3 提示词：证据、打印、导出与移动能力 |
| [docs/prompts/m7/wave-4-master-data.md](prompts/m7/wave-4-master-data.md)                 | `operations`    | `delivery` | M7 Wave 4 提示词：安全主数据中心             |
| [docs/prompts/m7/wave-5-plan-task.md](prompts/m7/wave-5-plan-task.md)                     | `operations`    | `delivery` | M7 Wave 5 提示词：计划任务、统一待办与日历   |
| [docs/prompts/m7/wave-6-inspection-capa.md](prompts/m7/wave-6-inspection-capa.md)         | `operations`    | `delivery` | M7 Wave 6 提示词：检查、问题与 CAPA          |
| [docs/prompts/m7/wave-7-release-acceptance.md](prompts/m7/wave-7-release-acceptance.md)   | `operations`    | `delivery` | M7 Wave 7 提示词：迁移、联调、上线与验收     |
| [docs/prompts/m8/wave-1-baseline-specs.md](prompts/m8/wave-1-baseline-specs.md)           | `operations`    | `delivery` | M8 Wave 1 提示词：M7 基线回归与专业规格冻结  |
| [docs/prompts/m8/wave-2-personnel-safety.md](prompts/m8/wave-2-personnel-safety.md)       | `operations`    | `delivery` | M8 Wave 2 提示词：人员安全与培训资格         |
| [docs/prompts/m8/wave-3-ship-operations.md](prompts/m8/wave-3-ship-operations.md)         | `operations`    | `delivery` | M8 Wave 3 提示词：航次与船舶高风险作业       |
| [docs/prompts/m8/wave-4-emergency-incident.md](prompts/m8/wave-4-emergency-incident.md)   | `operations`    | `delivery` | M8 Wave 4 提示词：应急、事故险情与防台       |
| [docs/prompts/m8/wave-5-equipment-spares.md](prompts/m8/wave-5-equipment-spares.md)       | `operations`    | `delivery` | M8 Wave 5 提示词：设备维护、修理、备件与采购 |
| [docs/prompts/m8/wave-6-safety-governance.md](prompts/m8/wave-6-safety-governance.md)     | `operations`    | `delivery` | M8 Wave 6 提示词：安全责任、费用与管理复查   |
| [docs/prompts/m8/wave-7-documents-audit.md](prompts/m8/wave-7-documents-audit.md)         | `operations`    | `delivery` | M8 Wave 7 提示词：受控文件、内审、统计与档案 |
| [docs/prompts/m8/wave-8-release-acceptance.md](prompts/m8/wave-8-release-acceptance.md)   | `operations`    | `delivery` | M8 Wave 8 提示词：全域联调、上线与验收       |
