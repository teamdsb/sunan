...
| [docs/specs/safety/state/evidence-jobs.md](specs/safety/state/evidence-jobs.md) | `current-spec` | `safety` | Wave 3 证据与导出状态 |
| [docs/specs/safety/state/inspection-capa-lifecycle.md](specs/safety/state/inspection-capa-lifecycle.md) | `current-spec` | `safety` | Wave 6 检查、问题与 CAPA 生命周期 |
| [docs/specs/safety/state/task-lifecycle.md](specs/safety/state/task-lifecycle.md) | `current-spec` | `safety` | Wave 5 计划、任务与消息生命周期 |
...
| [docs/specs/safety/ui/inspection-and-capa-pages.md](specs/safety/ui/inspection-and-capa-pages.md) | `current-spec` | `safety` | Wave 6 检查、问题与 CAPA 页面规格 |
...
| [docs/specs/safety/ui/task-center-and-calendar.md](specs/safety/ui/task-center-and-calendar.md) | `current-spec` | `safety` | Wave 5 任务中心、计划与日历页面规格 |
...
| [docs/archive/acceptance/common/acceptance-m7-wave2.md](archive/acceptance/common/acceptance-m7-wave2.md) | `acceptance-archive` | `delivery` | M7 Wave 2 验收记录：办事分类 CSS 与搜索体验 |
| [docs/archive/acceptance/common/acceptance-m7-wave3.md](archive/acceptance/common/acceptance-m7-wave3.md) | `acceptance-archive` | `delivery` | M7 Wave 3 验收记录：采购 PDF、返回与附件体验 |
| [docs/archive/acceptance/common/acceptance-m7-wave4.md](archive/acceptance/common/acceptance-m7-wave4.md) | `acceptance-archive` | `delivery` | M7 Wave 4 验收记录：工作台返回、密度与导航锚点 |
| [docs/archive/acceptance/common/acceptance-m7-wave5.md](archive/acceptance/common/acceptance-m7-wave5.md) | `acceptance-archive` | `delivery` | M7 Wave 5 验收记录：企业微信直达与跨模块回归 |
| [docs/archive/acceptance/common/acceptance-m7-wave6.md](archive/acceptance/common/acceptance-m7-wave6.md) | `acceptance-archive` | `delivery` | M7 Wave 6 验收记录：最终收口与 M8/M9 重启门禁 |
...
| [docs/superpowers/specs/2026-08-04-file-upload-preview-design.md](superpowers/specs/2026-08-04-file-upload-preview-design.md) | `current-spec` | `common` | 文件上传扩展与统一预览设计 |
| [docs/superpowers/specs/2026-08-04-global-controls-report-approval-design.md](superpowers/specs/2026-08-04-global-controls-report-approval-design.md) | `current-spec` | `frontend-procurement` | 全站控件与报表审批单体验优化设计 |
