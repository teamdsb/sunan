...
replaced_by: []
---
# M7-M8 升级总路线图：安全管理数字化闭环

## 1. 文档定位

本文是 M7、M8 的总规划入口，承接 M1-M6 已形成的企业微信 H5、四大板块、采购闭环和工作平台底座，并将平台从“通用动态表单与流程”升级为“可审计的航运安全管理领域平台”。
...
M7/M8 不新增第五个一级导航。专业安全能力继续归入“工作平台”，并支持企业微信工作台应用、消息和待办直接深链到目标任务。
...
M7/M8 明确不接通海事监管、AIS、CCTV、装载仪或其他外部平台。
...
| 里程碑 | 核心目标 | 完成标志 |
|---|---|---|
| M7 | 建成可信运行底座、计划任务中心和检查问题 CAPA 核心闭环 | 安全任务可分派、执行、留证、整改、验证、关闭和统计 |
| M8 | 建成人员、作业、应急、设备、文件内审等专业安全业务 | 主要安全管理体系链路在内部可完整运行并归档 |
...
- 如 M7 基础能力未通过验收，M8 对应依赖 Wave 不得开始。
