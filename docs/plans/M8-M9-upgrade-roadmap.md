...
M7 上线体验与导航修复已于 2026-07-10 验收归档，证据见 `docs/archive/acceptance/common/acceptance-m7-wave6.md`。M8 可从 Wave 1 启动；M9 仍等待 M8 总体验收。
...
本文是当前 M8/M9 升级规格入口；实施顺序仍以 Wave 前置验收为准。
