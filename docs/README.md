...
| 文档 | 状态 | 当前替代/说明 |
|---|---|---|
| [plans/M8-execplans.md](plans/M8-execplans.md) | `current-spec` | M7 已验收归档，可从 M8 Wave 1 启动 |
| [plans/M9-execplans.md](plans/M9-execplans.md) | `current-spec` | 等待 M8 总体验收；M9 Wave 1 先回归 M8 基线 |
