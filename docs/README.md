...
| M7 当前修复执行计划 | [plans/M7-execplans.md](plans/M7-execplans.md) |
| M8/M9 升级总路线图 | [plans/M8-M9-upgrade-roadmap.md](plans/M8-M9-upgrade-roadmap.md) |
| 当前计划与 Wave backlog | [plans/README.md](plans/README.md) |
| Wave 实施提示词 | [prompts/README.md](prompts/README.md) |
| M7 需求 | [requirements/M7-上线体验与导航修复.md](requirements/M7-上线体验与导航修复.md) |
...
| 文档 | 状态 | 当前替代/说明 |
|---|---|---|
| [plans/M8-execplans.md](plans/M8-execplans.md)、[plans/M9-execplans.md](plans/M9-execplans.md) | `current-spec` | 当前为后移待排期资料；M7 Wave 6 未验收前，不作为实施入口 |
