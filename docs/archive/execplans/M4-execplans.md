...
replaced_by: []
---
# M4 执行计划：工作平台全量业务实现（企业微信审批为主）（历史归档）

> M4 实现已完成（2026-04-21），本文档为历史参考。
...
- 已完成企业微信审批桥与上线约束冻结：
  - `docs/specs/wecom/approval-native-bridge-spec.md`
  - `docs/specs/wecom/workbench-go-live-checklist.md`
- 已完成 Wave 1 验收归档：`docs/archive/acceptance/workbench/acceptance-wave1.md`。
...
- 已完成 Wave 2 验收归档：`docs/archive/acceptance/workbench/acceptance-wave2.md`。
...
- 已完成 Wave 3 验收归档：`docs/archive/acceptance/workbench/acceptance-wave3.md`。
...
- 已完成 Wave 4 验收归档：`docs/archive/acceptance/workbench/acceptance-wave4.md`。
...
- 已完成 Wave 5 验收归档：`docs/archive/acceptance/workbench/acceptance-wave5.md`。
...
- 已完成前端统计看板：
  ...
  - 支持按月查询（`YYYY-MM`）
- 已完成 Wave 6 验收归档：`docs/archive/acceptance/workbench/acceptance-wave6.md`。
...
- 已完成企业微信审批发起链路接入：
  - `POST /api/v1/wecom/approval/launch`
  - 前端审批类详情页支持“发起企业微信审批”
- 已完成 Wave 7 验收归档：`docs/archive/acceptance/workbench/acceptance-wave7.md`。
...
- 已完成 M4 最终验收归档与 M5 输入沉淀：
  - `docs/archive/acceptance/workbench/acceptance-wave8.md`
