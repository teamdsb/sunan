...
## 5. 验收入口
- 验收文档：`docs/archive/acceptance/common/acceptance-m6-waved.md`
- 执行计划：`docs/execplans.md`、`docs/archive/execplans/M6-execplans.md`
- 修复清单：`docs/archive/backlogs/common/M6-优先级修复清单（分wave）.md`
